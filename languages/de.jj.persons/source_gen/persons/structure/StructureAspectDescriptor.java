...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForFemale() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("persons", "Female", 0xe6fbaca3ec58466aL, 0xb23c1a37f8435d3fL, 0x6dbbedacd97eaa9dL);
    b.class_(false, false, false);
    b.super_("persons.structure.Person", 0xe6fbaca3ec58466aL, 0xb23c1a37f8435d3fL, 0x6dbbedacd97eaa97L);
    b.origin("r:c08da0ef-d12c-451d-a223-796f006325cd(persons.structure)/7907174897418152605");
    b.version(2);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForMale() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("persons", "Male", 0xe6fbaca3ec58466aL, 0xb23c1a37f8435d3fL, 0x6dbbedacd97eaa9cL);
    b.class_(false, false, false);
    b.super_("persons.structure.Person", 0xe6fbaca3ec58466aL, 0xb23c1a37f8435d3fL, 0x6dbbedacd97eaa97L);
    b.origin("r:c08da0ef-d12c-451d-a223-796f006325cd(persons.structure)/7907174897418152604");
    b.version(2);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForPerson() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("persons", "Person", 0xe6fbaca3ec58466aL, 0xb23c1a37f8435d3fL, 0x6dbbedacd97eaa97L);
    b.class_(false, true, false);
    b.origin("r:c08da0ef-d12c-451d-a223-796f006325cd(persons.structure)/7907174897418152599");
    b.version(2);
  ...
  private static ConceptDescriptor createDescriptorForPersons() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("persons", "Persons", 0xe6fbaca3ec58466aL, 0xb23c1a37f8435d3fL, 0x6dbbedacd97eaaa1L);
    b.class_(false, false, true);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:c08da0ef-d12c-451d-a223-796f006325cd(persons.structure)/7907174897418152609");
    b.version(2);
